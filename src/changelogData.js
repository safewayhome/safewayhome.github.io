...
export const SYSTEM_DESC = {
  tagline: 'LedMig räknar ut den tryggaste vägen hem, inte den snabbaste.',
  paragraphs: [
    'Det är sent, det är mörkt och du har en bit kvar att gå. Du tar den upplysta gatan, inte genvägen. LedMig är byggd för det läget. Du skriver in var du är och vart du ska, så räknar appen ut den tryggaste vägen i stället för den snabbaste. Varje gatusträcka får ett säkerhetsbetyg mellan 0 och 100, och rutten styr runt platser som bedöms som mer otrygga. Allt visas på en vanlig karta med beräknad gångtid.',
    'Betygen bygger på data, inte gissningar. Huvudkällan är polisens öppna händelse-API, som redan är avidentifierat och inte innehåller namn eller personnummer. Till det läggs väder och sikt från SMHI (i mörker och dimma väljer appen hellre upplysta stråk), kollektivtrafikförseningar och vägdata, till exempel om det finns trottoarer. Gamla händelser väger mindre med tiden, och har det kommit ny belysning eller annan trygghetsinfra efteråt dämpas den gamla risken. Appen pekar också ut trygga punkter som är öppna dygnet runt: bensinmackar, sjukhus och polisstationer.',
    'Känns något fel under promenaden finns ett tyst nödläge. En person du litar på kan vaka över din väg och se att du checkar in och kommer fram, men servern får aldrig din exakta GPS i klartext, den jämför bara skyddade, krypterade koder. Du har två PIN-koder: en avbryter ett larm, och en nödkod skickar larm i hemlighet medan skärmen ser ut som om appen är avstängd, för lägen där du inte vågar visa att du ringer efter hjälp. En nedräkning på fem sekunder hinner stoppa falsklarm.',
    'Var datan kommer ifrån är centralt. Appen använder bara lagliga, öppna och avidentifierade källor, tvättar bort personuppgifter automatiskt, och går tvätten inte att göra säkert sparas ingenting. Olaglig skrapning är borttagen. Det här är ett pågående examensarbete, så allt är inte klart. Klart: databas, karta, adress-till-adress-navigering, säkerhetsruttens kärna, de lagliga datakällorna, och appen ligger i molnet. Påbörjat eller på ritbordet: framför allt det som ska bo i själva mobilen, som det tysta nödläget och larm utan internet. En genomgående regel är att om en datakälla ligger nere faller appen tyst tillbaka på något neutralt i stället för att krascha eller ge falsk trygghet.',
  ],
  principles: [
...
export const CHANGELOG = [
  ...
  { order: 14, period: 'Maj 2026', title: 'Team-board: whiteboard, tidslinje & framsteg', area: 'dev', status: 'done', desc: 'Delad realtidstavla på GitHub Pages med Supabase Postgres + Realtime och React Flow: korten sparas i en delad databas, synkas live till alla, har redigeringshistorik per kort och visar vem som skapat dem. Den sida du tittar på just nu.' },
